  ...
  <script type="text/javascript">
        ...
        $(window).on('bottom', function() {
            ...
            if (!obj.data('loading')) {
                ...
                setTimeout(function(){ 
                    ...
                    $.ajax({
                        type:"GET",
                        url: "/android/myfeed/home/getitems/?page="+page_cnt+"&sort="+sort+"&_disfa="+_disfa,
                        cache: false,
    ...
    {
        var url = '/android/myfeed/bookmark/change/';
        params = getParams(id);
    ...
    {
        var url = '/android/myfeed/bookmark/delete/';
        params = getParams(id);
    ...
    function autoJump(){
        location.href="/android/error/home/index/error00/";
    }
